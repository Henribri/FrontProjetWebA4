<template>
  <div>
    <div
      class="flex flex-initial flex-col md:flex-row justify-around items-center text-blue-500 bg-white text-7xl font-bold m-6">
      <NuxtLink to="/">
        <div>Ceseat</div>
      </NuxtLink>
      <div class="navbar-onglet"> Mes livraison </div>
